...
public class OIDP_Email_Auto_Approval_Flow_2 {
	...
	//**************************************Main Functions****************************************
		...
		public void removeHoldAndMarkCompleted() {
			...
			scrollingFunction();
			Utils.sleep(1);
			driver.findElement(By.xpath("//a[contains(text(),'Hold')]/parent::*/parent::*/following-sibling::td[4]/div/a")).click();
			Utils.sleep(2);
			...
			fluentWaitForElementVisibility();
			Utils.sleep(2);
			element = driver.findElement(By.xpath("//span[contains(text(),'Status')]/following-sibling::div/div/span[text()='Assigned']"));
			highlightElement();
			...
			Utils.sleep(2);
			try {
				element = driver.findElement(By.xpath("//span[contains(text(),'Status')]/following-sibling::div/div/span[text()='Completed']"));
				highlightElement();
			} catch (Exception e) {
				driver.navigate().refresh();
				ele = By.xpath("//a[@title='Edit']");
		...
		public void relatedServiceItemCreation(String siOrigin) {
			element = driver.findElement(By.xpath("//span[@title='Holds']"));
			scrollingFunction();
			Utils.sleep(3);
			element = driver.findElement(By.xpath("//span[@title='Holds']"));
			scrollingFunction();
		...
		public void verifyChildServiceItem () {
			driver.findElements(By.xpath("//span[text()='Details']")).get(1).click();
			Utils.sleep(2);
			element = driver.findElement(By.xpath("//span[text()='Resolution Details']/parent::button"));
			scrollingFunction();
			Utils.sleep(2);
			relatedSINo = driver.findElement(By.xpath("//span[text()='Service Item Number']/parent::div/following-sibling::div/descendant::*[@class='uiOutputText']")).getText();
		...
		public void cloneMerge () {
			...
			highlightElement();
			Utils.sleep(2);
			element = driver.findElements(By.xpath("//span[contains(text(),'"+subjectLine+"')]/parent::div")).get(1);
			highlightElement();
			Utils.sleep(1);
			...
			fluentWaitForElementVisibility();
			Utils.sleep(2);
			driver.findElements(By.xpath("//span[text()='Details']")).get(0).click();
			Utils.sleep(2);
			element = driver.findElement(By.xpath("//span[text()='Service Item Details']/parent::button"));
			scrollingFunction();
			Utils.sleep(2);
			cloneSINo = driver.findElement(By.xpath("//span[text()='Service Item Number']/parent::div/following-sibling::div/descendant::*[@class='uiOutputText']")).getText();
			element = driver.findElement(By.xpath("//span[text()='Inquiry Information']/parent::*/parent::h3/parent::div/preceding-sibling::div[1]"));
			scrollingFunction();
			Utils.sleep(2);
			element = driver.findElement(By.xpath("//span[text()='Inquiry Information']/parent::button/parent::*/following-sibling::div/div/div[1]/div[1]"));
			highlightElement();
			Utils.sleep(1);
			element = driver.findElement(By.xpath("//span[text()='Inquiry Information']/parent::button/parent::*/following-sibling::div/div/div[1]/div[2]"));
			highlightElement();
			Utils.sleep(1);
			element = driver.findElement(By.xpath("//span[text()='Inquiry Information']/parent::button/parent::*/following-sibling::div/div/div[2]/div[1]"));
			highlightElement();
			Utils.sleep(1);
			element = driver.findElement(By.xpath("//span[text()='Inquiry Information']/parent::button/parent::*/following-sibling::div/div/div[2]/div[2]"));
			highlightElement();
			Utils.sleep(1);
			element = driver.findElement(By.xpath("//span[text()='Inquiry Information']/parent::button/parent::*/following-sibling::div/div/div[3]/div[1]"));
			highlightElement();
			Utils.sleep(1);
			element = driver.findElement(By.xpath("//span[text()='Inquiry Information']/parent::button/parent::*/following-sibling::div/div/div[3]/div[2]"));
			highlightElement();
			Utils.sleep(2);
			driver.navigate().refresh();
			Utils.sleep(4);
			...
			fluentWaitForElementVisibility();
			Utils.sleep(4);
			element = driver.findElement(By.xpath("//span[contains(text(),'Status')]/following-sibling::div/div/span[text()='Archived']"));
			highlightElement();
			Utils.sleep(1);
		}
		public void submitResponseFromClone () throws Exception {
			...
			fluentWaitForElementVisibility();
			Utils.sleep(4);
			element = driver.findElement(By.xpath("//span[contains(text(),'Status')]/following-sibling::div/div/span[text()='Approved']"));
			highlightElement();
			Utils.sleep(1);
			element = driver.findElement(By.xpath("//span[@title='Emails']"));
			scrollingFunction();
