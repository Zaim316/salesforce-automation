...
public class Iso_11790_Internal_Function extends CommonServiceItemTestScenario{
	...
	public void createNewIncidentSI() throws IOException {
		...
		((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();", 
				driver.findElement(By.xpath("//span[text()='Violator']/parent::*/parent::*")));
		Utils.sleep(2);
	...
	public void changeTheTypeField() throws IOException {
		...
		Utils.sleep(2);
		(new WebDriverWait(driver, 10)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()='Type']/parent::*/following-sibling::div/span/span[text()='']")));
		((JavascriptExecutor) driver).executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", 
		driver.findElement(By.xpath("//span[text()='Type']/parent::*/following-sibling::div/span/span[text()='']")));
