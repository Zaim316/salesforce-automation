...
public class MultiTypeServiceItemCreator extends CommonServiceItemTestScenario {
	...
	public String create_pia_service_item_manually(String contact) {
		try {
	...
	public void send_email_from_pia_service_item(String toEmail) {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void send_pia_service_item_for_approval() {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void close_pia_service_item() {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void create_sorn_service_item_manually(String contact) {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void close_sorn_service_item() {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void create_privacy_service_item_manually(String contact) {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void send_email_from_privacy_notice(String toEmail) {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void create_pta_service_item_manually(String attachmentUrl, String contact) {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void close_pta_service_item() {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void merge_service_items(String parent, String child) {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
	...
	public void close_privacy_service_item() {
		try {
			ServiceItemsAction serviceAction = new ServiceItemsAction(driver, testReporter);
