...
public class exso_scenario_1 {
	...
	public void Send_Mail_To_URL() throws IOException {
		try {
	...
	public void clickOnSISetDueandETC() throws Exception {
		...
		Utils.sleep(2);
		element = driver1.findElement(By.xpath("//span[@class='uiOutputText' and contains(text(),'"+exsoSI+"')]/parent::*"));
		highlightElement();
		...
		Utils.sleep(2);
		driver1.findElement(By.xpath("//a[contains(@title,'Legacy System')]")).click();
		Utils.sleep(1);
		...
		fluentWaitForElementVisibility();
		driver1.findElement(By.xpath("//span[text()='Done']/parent::*")).click();
		Utils.sleep(2);
		driver1.navigate().refresh();
		ele = By.xpath("//span[text()='Signature Level']");
		fluentWaitForElementVisibility();
	...
	public void logInAsPodUser() {
		...
		driver1.navigate().to("https://uscis2--uat2.lightning.force.com/lightning/o/Contact/home");
		Utils.sleep(4);
...
//		driver1.switchTo().defaultContent();
	...
	public void completeAssiAAO () {
		...
		try {
			...
			driver1.findElement(By.xpath("//td[1]/span[@class='lookupInput']/input")).click();
		}
		Utils.sleep(1);
	...
	public void completeAssiAAO_Round2 () {
		...
		//driver1.findElement(By.xpath("//textarea")).sendKeys("Automated test comments");
		//driver1.findElement(By.xpath("//input[@type='checkbox' and not(contains(@checked,'checked'))]")).click();
		selectDropdownListValue("Concur", driver1.findElement(By.xpath("//div[@class='pbSubsection']/table/tbody/tr[3]/descendant::select")));
		Utils.sleep(1);
		driver1.findElement(By.xpath("//input[@value='Save']")).click();
		Utils.sleep(4);
		driver1.switchTo().defaultContent();
...
//		highlightElement();
	...
	public void completeAssignPVY_Round2 () {
		...
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(driver1.findElement(By.xpath("//iframe[contains(@name,'vfFrameId')]"))));
		try {
		driver1.findElement(By.xpath("//td[2]/span[@class='lookupInput']/input")).sendKeys("PVY Contact 1");
		} catch (Exception e) {
		...
		//driver1.findElement(By.xpath("//textarea")).sendKeys("Automated test comments");
		//driver1.findElement(By.xpath("//input[@type='checkbox' and not(contains(@checked,'checked'))]")).click();
		selectDropdownListValue("Do Not Concur", driver1.findElement(By.xpath("//div[@class='pbSubsection']/table/tbody/tr[3]/descendant::select")));
		Utils.sleep(1);
		driver1.findElement(By.xpath("//input[@value='Save']")).click();
		Utils.sleep(4);
...
//		highlightElement();
	...
	public void completeAssignWithAAO_Round4 () throws Exception {
		...
		Utils.sleep(2);
		//driver1.findElement(By.xpath("//textarea")).sendKeys("Automated test comments");
		selectDropdownListValue("Concur with Edits / Comments", driver1.findElement(By.xpath("//div[@class='pbSubsection']/table/tbody/tr[3]/descendant::select")));
		Utils.sleep(1);
		element = driver1.findElement(By.xpath("//input[@value='Save']"));
		scrollingFunction();
		Utils.sleep(1);
