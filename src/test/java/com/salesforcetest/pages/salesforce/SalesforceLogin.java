...
public class SalesforceLogin {
	...
	public void fetchMailUrl (String addName) {
		...
		driver.findElement(By.xpath(".//*[@id='oneHeader']/div[2]/span/div/ul/li[6]/div")).click();
		}
		Utils.sleep(4);
	...
	public void internalUserLogin(String internalUserNm) {
		...
		driver.findElement(By.xpath(".//*[@id='oneHeader']/div[2]/span/div/ul/li[6]/div")).click(); //QA env
		}
		Utils.sleep(4);
		driver.findElement(By.xpath(".//*[@id='related_setup_app_home']/a/div[1]/div[1]/span/span[2]")).click();
		Utils.sleep(2);
	...
	public void logout() {
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", 
				driver.findElement(By.xpath(".//*[@id='oneHeader']/div[2]/span/div[2]/ul/li[8]")));
		Utils.sleep(2);
		driver.findElement(By.xpath(".//*[@id='oneHeader']/div[2]/span/div[2]/ul/li[8]")).click();
