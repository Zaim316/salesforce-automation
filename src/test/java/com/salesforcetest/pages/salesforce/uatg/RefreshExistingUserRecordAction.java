...
public class RefreshExistingUserRecordAction {
	...
	public void logInAsInternalUser(String user) {
		...
		driver1.switchTo().defaultContent();
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(driver1.findElement(By.xpath("//div[@id='navigatortab']/descendant::iframe[2]"))));
		driver1.findElement(By.xpath("//*[text()='Mobile User']")).click();
		Utils.sleep(1);
	...
	public String fetchServiceItemNo() {
		...
		highlightElement();
		newSINo1 = driver1.findElement(By.xpath("//span[text()='Service Item Number:']/following-sibling::span")).getText();
	...
	public void setPercentage(String percentageValue) throws AWTException { //String applicationRecord
		...
		Utils.sleep(2);
		ele1 = By.xpath(".//*[contains(text(),'Successfully updated QC Percentage for ISOs')]");
		fluentWaitForElementVisibility();
		element1 = driver1.findElement(By.xpath(".//*[contains(text(),'Successfully updated QC Percentage for ISOs')]"));
		highlightElement();
		driver1.switchTo().defaultContent();
	}
